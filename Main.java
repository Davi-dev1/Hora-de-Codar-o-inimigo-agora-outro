import java.sql.SQLOutput;import java.util.Scanner;public class Main {    public static void main(String[] args) {        String text = " ";        int idade = 0;        int area = 0;
    // Exercício 1
    ...
    if (numero2 < 0) {            System.out.println("O número é negativo");
    } else if (numero2 > 0) {            System.out.println("O número é positivo");
    } else {            System.out.println("O número é neutro");        }
    System.out.println("Digite o terceiro número: ");
    double numero3 = entradaDados.nextDouble();
    if (numero3 < 0) {
        System.out.println("O número é negativo");
    } else if (numero3 > 0) {            System.out.println("O número é positivo");
    } else {            System.out.println("O número é neutro");        }
    ...
    } else {            System.out.println("O maior número é: " + terceironumero);        }
    ...
    while (terceironumero1 == primeironumero1 || terceironumero1 == segundonumero1){
        System.out.println("Digite um número diferente dos dois primeiros: ");
        terceironumero1 = entradaDados.nextDouble();        }        System.out.println("Digite o quarto número: ");
    ...
    if (primeironumero1 > segundonumero1 && primeironumero1 > terceironumero1 && primeironumero1 > quartonumero1){
        ...
        System.out.println("O maior número é: " + terceironumero1);        } else {
    ...
    } else {            System.out.println("A soma dos dois números maiores é igual a: " + segundonumero2 + terceironumero2);
    ...
    if (primeironumero3 > segundonumero3 && primeironumero3 > terceironumero3 && primeironumero3 > quartonumero3 && primeironumero3 > quintonumero3){
        ...
        System.out.println("O maior número é: " + terceironumero3);        } else if (quartonumero3 > primeironumero3 && quartonumero3 > segundonumero3 && quartonumero3 > terceironumero3 && quartonumero3 > quintonumero3){
        System.out.println("O maior número é: " + quartonumero3);        } else {            System.out.println("O maior número é: " + quintonumero3);        }
    ...
    if (mediadoaluno >= 6){            System.out.println("Aluno foi aprovado");
    ...
    while (inicio >= fim){
        ...
        inicio--;        }        System.out.println("BOOOOMMM. A BOMBA EXPLODIU!");
    // Exercício 12            }
     }}